...
class TestTCA(unittest.TestCase):
    ...
    def test_init(self):
        # Test si l'initialisation se passe bien
    ...
    def test_plot_treatment_percentages(self):
        ...
        # Cette partie nécessite une vérification manuelle ou l'utilisation d'une bibliothèque de mock pour tester les appels de fonction de plotly
